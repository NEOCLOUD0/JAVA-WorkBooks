...
public class AreaCalculator {
	 ...
	 * 
	 *         Inside the function: 1. If the side is negative, prints "Error:
	 *         impossible" and terminates the java program. 2. Calculates the area
	 *         of the square. A = side²
	 */
	 ...
	 * @return the area (double)
	 * 
	 *         Inside the function: 1. If the length OR width is negative, prints
	 *         "Error: impossible" and terminates the program. 2. Calculates the
	 ...
	 * @return the area (double)
	 * 
	 *         Inside the function: 1. If the base OR height is negative, prints
	 *         "Error: impossible" and terminates the program. 2. Calculates the
	 *         area of the triangle. A = (base * height)/2
	 */
	 ...
	 * @return area (double)
	 * 
	 *         Inside the function: 1. If the radius is negative, prints "Error:
	 *         impossible" and terminates the program. 2. Calculates the area of the
	 *         circle.
	 */
	 ...
	 * 
	 *                  Inside the function: 1. print: ("Square area: <square
	 *                  area>") 2. print: ("Rectangle area: <rectangle area>") 3.
	 *                  print: ("Triangle area: <triangle area>") 4. print: ("Circle
	 *                  area: <circle area>")
	 * 
	 */
